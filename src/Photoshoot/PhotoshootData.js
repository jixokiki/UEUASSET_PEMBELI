    ...
    return(
        <div className="p-card">
            <div className="photoshoot-image">
                {/* <img value={image} onChange={(e) => setName(e.target.value)} src={props.image} alt="image"/> */}
            ...
            <p>{props.text2}</p>
            {/* <nav>
                <NavLink exact="true" activeclassname="active" className="college-photoshoot-data-link" to="/">
